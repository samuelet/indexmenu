...
$lang['page_index']            = 'Die Seite die den DokuWiki Index ersetzen soll. Erstellen Sie diese und f&uuml;gen Sie folgende Indexmenu Syntax ein. Nehmen Sie <code>id#random</code> falls Sie bereits eine Indexmenu Sidebar mit der Navigations-Option verweden. Mein Vorschlag ist <code>{{indexmenu>..|js navbar nocookie id#random}}</code>.';
$lang['empty_msg']             = 'Nachricht die angezeigt wird, falls der Baum leer ist. Verwenden Sie Dokuwiki syntax, kein HTML Code. Die <code>{{ns}}</code> Variable ist eine Abk&uuml;rzung f&uuml;r den verwendeten Namespace.';
$lang['skip_index']            = 'Namespaces die nicht aufgenommen werden sollen. Sie m&uuml;ssen Regular Ausdr&uuml;cke verweden. Beispiel: <code>/(sidebars|private:myns)/</code>';
$lang['skip_file']             = 'Dateien die nicht aufgenommen werden sollen. Sie m&uuml;ssen auch Regular Ausdr&uuml;cke verweden. Beispiel: <code>/(:start$|^public:newstart)/</code>';
