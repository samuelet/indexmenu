...
$lang['page_index']             =       'La página que sustituirá el índice principal de dokuwiki. Créalo e insértalo en la sintaxis de indexmenu. Usa id#random si ya tienes una barra lateral de indexmenu con la opción navbar. Mi sugerencia es "{{indexmenu>..|js navbar nocookie id#random}}".';
$lang['empty_msg']		=	'Mensaje para mostrar cuando el árbol está vacío. Usa sintaxis de DokuWiki,no código html. La variable {{ns}} es un enlace al espacio de nombres solicitado.';
$lang['skip_index']	        =	'Espacios de nombres a ignorar. Usa el formato de las expresiones regulares. Ejemplo: /(sidebars|private:myns)/';
$lang['skip_file']		=	'Archivos a ignorar. Usa el formato de las expresiones regulares. Ejemplo: /(:start$|^public:newstart)/';
