...
$lang['defaultoptions']        = 'Liste des éléments du menu d\'indexation séparer par des espaces. Ces options seront appliqué par défaut sur tous les menus d\'indexation, et vous pourrez les annuler avec la commande de retour en arrière dans la syntax du plugin';
