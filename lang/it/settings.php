...
$lang['page_index']             =       'La pagina che sostituir&agrave; l\'indice di dokuwiki. Creala and inserisci la sintassi di indexmenu. Usa id#random se hai gi&agrave; una sidebar con indexmenu e l\'opzione navbar. Il mio suggerimento &egrave "{{indexmenu>..|js navbar nocookie id#random}}".';
...
$lang['skip_index']	        =	'Id dei namespaces Namespaces da nascondere. Utilizzare il formato delle Espressioni Regolari. Esempio: /(sidebars|private:myns)/';
$lang['skip_file']		=	'Id delle pagine da nascondere. Utilizzare il formato delle Espressioni Regolari. Esempio: /(:start$|^public:newstart)/';
