...
$lang['install_ok']            = '테마가 성공적으로 설치되었습니다. 새 테마는 편집 문서의 도구모음이나 <code>js#theme_name option</code>으로 사용할 수 있습니다.';
...
$lang['js']['noscroll']        = '트리의 컨테이너 너비에 맞추지 않으면 트리의 스크롤을 막기';
$lang['js']['notoc']           = '목차 미리 보기 기능 비활성화';
$lang['js']['tsort']           = '제목별';
$lang['js']['dsort']           = '날자별';
$lang['js']['msort']           = '메타 태그별';
$lang['js']['nsort']           = '이름공간도 정렬';
$lang['js']['hsort']           = '시작문서의 위에 정렬';
$lang['js']['rsort']           = '반대로 문서 정렬';
$lang['js']['nons']            = '문서만 보기';
