...
$lang['install_ok']            = 'тема успешно установена. Новые темы доступны в панели инструментов страницы редактирования или с помощью <code>js#theme_name option</code>.';
...
$lang['noupdates']             = 'Индекс меню не нуждается в обновлении. У Вас актуальная версия.';
...
$lang['js']['indexmenuwizard'] = 'Мастер индекса меню';
